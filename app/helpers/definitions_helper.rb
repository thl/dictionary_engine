	...
	['Edit Relationships', null, null,
	  ['Add Sub Definition',\"javascript:add_def_popup('definitions',definition_id,parent_id);\",null],		  
		['Add Related Term', null, null,
  		['full synonym', \"javascript:search_term('full_synonyms','full_synonym',definition_id);\"],
		  ['partial synonym',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'partial synonym','partial synonym');\"],
		  ...
		  ['dialectical correlate',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'dialectical correlate','dialectical correlate');\"],
		  ...
		  ['register', null, null,
		    ...
		    ['high honorific form',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'high honorific form','non-honorific form');\"],
		    ['honorific form',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'honorific form','non-honorific form');\"],
		    ['humilific form',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'humilific form','non-honorific form');\"]
		  ],
		  ['conjugated form', null, null,
    	  ['past tense',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'past tense','present tense');\"],
    	  ['future tense',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'future form','present tense');\"],
    	  ['imperative tense',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'imperative form','present tense');\"]
	    ],
		  ['division',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'division','division of');\"],
		  ['division of',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'division of','division');\"],
		  ['containing compound',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'compound','part of compound');\"],
		  ['part of compound',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'part of compound','compound');\"],
		  ['abbreviation',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'abbreviation','non-abbreviated form');\"],
		  ['non-abbreviated form',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'non-abbreviated form','abbreviation');\"],
		  ['containing phrase',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'phrase','part of phrase');\"],
		  ['part of phrase',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'part of phrase','phrase');\"],
		  ['poetic correlate',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'poetical correlate','non-poetical correlate');\"],
		  ['non-poetic correlate',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'non-poetical correlate','poetical correlate');\"],
		  ['gloss',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'gloss','gloss term');\"],
		  ['glossed term',\"javascript:related_term_search('definition_definition_forms','definition_definition_form_from',definition_id,'gloss term','gloss');\"],
		],
